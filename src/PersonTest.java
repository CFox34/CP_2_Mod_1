...
public class ProductTest {
    ...
    private static final String FILENAME = "productData.txt";
    ...
    private static ArrayList<Person> readFile(String filename)
    {
        ...
        try
        {
            ...
            while(fileReader.hasNextLine())
            {
                ...
                res.add(new Person(ID, name, description, cost));
            }
            fileReader.close();
    ...
    private static int getIndex(ArrayList<Person> people, String id)
    {
        int index = -1;
    ...
    private static void addProduct(ArrayList<Person> people)
    {
        Scanner sc = new Scanner(System.in);
        System.out.print("Enter person id: ");
        String ID = sc.nextLine().trim();
        int index = getIndex(people, ID);
        if(index == -1)
        {
// product not present, good to add
            ...
            System.out.print("Enter person YOB: $");
            int YOB = int.parseint(sc.nextLine().trim());
            people.add(new Person(ID, name, title, YOB));
